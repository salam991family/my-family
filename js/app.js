...
const translations = {
  ur: {
    ...
    username_lbl: "یوزر نیم (Username)",
    password_lbl: "پاس ورڈ (Password)",
    ...
    feat_1: "<b>فنڈز کا حساب:</b> صاف اور شفاف مالیاتی حساب کتاب بذریعہ ایزی پیسہ، جیز کیش اور بینک اکاؤنٹس (ایڈمن اپروول کے ساتھ)۔",
    ...
    curr_bal_label: "موجودہ کل فیملی فنڈ (Current Net Balance)",
    rec_fund_label: "موصول فنڈ (Receive Fund)",
    pen_fund_label: "پینڈنگ (Pending Fund)",
    spent_fund_label: "خرچ فنڈ (Spent Fund)",
    total_mem_label: "کل ممبرز",
    history_label: "ہسٹری فنڈز (History Funds)",
  ...
  en: {
    ...
    feat_1: "<b>Fund Accounting:</b> Transparent financial tracking via Easypaisa, JazzCash, and Bank accounts with admin approval.",
